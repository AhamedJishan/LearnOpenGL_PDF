...
int main()
{
	...
	Shader screenShader("src/res/shaders/screenShader.vert", "src/res/shaders/screenShader.frag");
	...
	// Creating a renderbuffer object for depth and stencil attachments (we won't be sampling these)
	unsigned int rbo;
