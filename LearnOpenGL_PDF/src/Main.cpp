...
int main()
{
	...
	// -------------------------
	Shader parallaxShader("src/res/shaders/parallaxShader.vert", "src/res/shaders/parallaxShader.frag");

	// Load Models/Textures
	// --------------------
	unsigned int brickDiffuse = LoadTexture("src/res/textures/bricks2.jpg");
	unsigned int brickNormal = LoadTexture("src/res/textures/bricks2_normal.jpg");
	unsigned int brickDisplacement = LoadTexture("src/res/textures/bricks2_disp.jpg");

	// Shader Configurations
	// ---------------------
	parallaxShader.Use();
	parallaxShader.SetInt("texture_diffuse", 0);
	parallaxShader.SetInt("texture_normal", 1);
	parallaxShader.SetInt("texture_displacement", 2);
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, brickDiffuse);
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, brickNormal);
	glActiveTexture(GL_TEXTURE2);
	glBindTexture(GL_TEXTURE_2D, brickDisplacement);
